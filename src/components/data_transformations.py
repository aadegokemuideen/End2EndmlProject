    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            num_pipeline =Pipeline(
                ...
                ("scaler",StandardScaler()), # with_mean=False need to be remove normally
                ]
            ) 
            ...
            cat_pipeline = Pipeline(
                ...
                ("scaler",StandardScaler(with_mean=False)) #with_mean = False, need to be remove normally
                ]
            )

            logging.info(f"Numerical columns:{numerical_columns}")

            logging.info(f"Cateorical columns:{categorical_columns}")
